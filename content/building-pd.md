...
these are basic instructions on building Pd for many platforms. for in-depth instructions see [Pd manual chapter 6](https://msp.ucsd.edu/Pd_documentation/6.building.from.source.htm).
